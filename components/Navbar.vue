        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <NuxtLink class="navbar-brand" to="/">
                    <img src="../public/bubbles.png" class="logo img-fluid" alt="">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><NuxtLink class="dropdown-item" to="/services">Our Services</NuxtLink></li>

                                <li><NuxtLink class="dropdown-item" to="/comingsoon">Coming Soon</NuxtLink></li>

                                <li><NuxtLink class="dropdown-item" to="/page-404">Page 404</NuxtLink></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item ms-3">
                            <NuxtLink class="nav-link custom-btn custom-border-btn custom-btn-bg-white btn" to="https://www.github.com/markbeeumii">Get started</NuxtLink>
                        </li>
                    </ul>
                </div>
            </div>
